...
vndk-test-sepolicy: $(PRODUCT_OUT)/system/etc/selinux/plat_sepolicy.cil checkpolicy $(vndk-test-sepolicy-targets-26) $(vndk-test-sepolicy-targets-27)
...
%-26-selinux-tested: %.cil
	./out/host/linux-x86/bin/secilc $(PRODUCT_OUT)/system/etc/selinux/plat_sepolicy.cil -o $@ -M true -G -N -c 30 $(PRODUCT_OUT)/system/etc/selinux/mapping/26.0.cil $<
